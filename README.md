...
- [x] [multiprecision](multiprecision) - A set of classes to work with big ints, fixed-point and rationals. Includes arithmetic library and a set of math functions including trigonometric functions.
