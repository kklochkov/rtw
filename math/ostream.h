...
{
  os << "Vector" << N;
  return details::operator<< <details::FormatType::VECTOR>(os, vector.as_matrix());
}
...
{
  os << "Point" << N;
  return details::operator<< <details::FormatType::VECTOR>(os, point.as_matrix());
}
...
{
  os << "Barycentric";
  return math::details::operator<< <details::FormatType::VECTOR>(os, coord.as_matrix());
}
